...
`;
                    ...
                    if (Array.isArray(data) && data.length > 0) {
                        data.forEach(order => {
                            ...
                            <td data-label="Quantity:"><input type="number" class="edit-quantity" style="max-width: 60px; width: 100%; padding: 5px; box-sizing: border-box; font-size: 1rem;" value="${order.quantity}" min="1" disabled></td>
                            <td data-label="Price:">${parseFloat(order.price).toFixed(2)}</td>
                            <td data-label="Total:" class="total-price">${totalPrice}</td>
                            <td>
